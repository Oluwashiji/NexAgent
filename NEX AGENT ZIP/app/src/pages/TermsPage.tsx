  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-slate-300 mb-10">Last updated: 2026</p>

        <div className="space-y-8 text-slate-300 leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">3. Your Account</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">5. Your Content</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">6. AI-Generated Responses</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">7. Plans and Payment</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">8. Termination</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">9. Disclaimer & Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50           mb-2">10. Changes to These Terms</h2>
