  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-slate-50 italic leading-relaxed">
            "NexAgent transformed how we handle customer inquiries. Response times dropped to zero and our team can focus on growth."
          </p>
          <p className="mt-4 text-sm text-slate-400">— Sarah Chen, CEO at TechFlow</p>
        </div>
      ...
      <motion.div
        ...
        className="flex-1 flex items-center justify-center p-6 sm:p-12 lg:p-20 relative"
      >
        {/* Back Link */}
        <Link
          to="/"
        ...
        <div className="w-full max-w-[420px]">
          ...
          >
            ...
            <p className="mt-2 text-slate-400">Enter your details to sign in</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-brand-blue hover:underline cursor-pointer">Forgot?</span>
              </div>
              <input
                type="password"
                value={password}
