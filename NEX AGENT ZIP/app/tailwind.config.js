  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 4px 24px rgba(36, 28, 20, 0.08)',
        'card-hover': '0 8px 40px rgba(4, 120, 87, 0.15)',
        'glow-blue': '0 0 60px rgba(4, 120, 87, 0.25)',
        'glow-violet': '0 0 60px rgba(212, 175, 55, 0.25)',
        'dropdown': '0 20px 60px rgba(36, 28, 20, 0.15)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
